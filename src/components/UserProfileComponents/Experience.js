...
const Experience = () => {
                    ...
                    <div className="edu-Modal-container">
                        ...
                        <div className="edu-modal-form">
                            ...
                            <TextField className='textField' fullWidth label="Job Status" id="fullWidth" name="jobStatus" value={expData.data?.jobStatus} />
                                ...
                                <TextField className='textField' fullWidth label="Job Title" id="fullWidth" name="jobTitle" value={expData.data?.jobTitle} />

                                <TextField className='textField' fullWidth label="Comapny Name" id="fullWidth" name='companyName' value={expData.data?.companyName} />
    ...
    return (
        <div className="edu-Modal-wrapper">
            <div className="edu-Modal-container">
                <button style={{ float: 'left', cursor: 'pointer', fontSize: '24px', marginLeft: '-5px', backgroundColor: 'transparent', border: 'none', }} onClick={() => { props.backExp }}><IoArrowBackCircle /></button>
